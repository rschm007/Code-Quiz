...
// define a var for the high score list at the end of the quiz
// define var for high score prompt card
var highScores =
  "<div class='d-flex justify-content-center highScores'><div class='card qst-header'><h3>High Scores</h3></div>";
