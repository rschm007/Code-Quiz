...
var questionOne = "<div class='d-flex justify-content-center'><h3>Question 1: Commonly used data types DO NOT include: </h3> </div>"
var questionTwo = "<div class='d-flex justify-content-center'>><h3>Question 1: The condition in an if/else statement is enclosed within: </h3> </div>"
var questionThree = "<div class='d-flex justify-content-center'>><h3>Question 1: Arrays in JavaScript can be used to store: </h3> </div>"
var questionFour = "<div class='d-flex justify-content-center'>><h3>Question 1 String values must be enclosed within ___ when being assigned to variables :</h3> </div>"
var questionFive = "<div class='d-flex justify-content-center'>><h3>Question 1: String values must be enclosed within ___ when being assigned to variables </h3> </div>"
